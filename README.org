...
** Introduction
   ...
   for [[https://github.com/company-mode/company-mode][company-mode]]. For example, when writing $\LaTeX$ document, I
   can use command =company-manually-add-candidate-at-point= or
